        ...
        if(this.state.activeTab === 0){
          ...
          /* Nodejs projects section */  
                ...
                return (
                    ...
                    <CardText style={{paddingBottom: '5px'}}>
                    <p style={{margin: '0px',padding: '0px'}}><h6 style={{margin: '0px', fontWeight: 'bolder'}}>Employee Tracker</h6>A command-line application built to allow user to keep track of employees, add or update their role, department, salary or user id.</p>
                    </CardText>
                    <CardActions border>
